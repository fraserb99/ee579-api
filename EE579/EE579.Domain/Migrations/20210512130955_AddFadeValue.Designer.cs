...
namespace EE579.Domain.Migrations
{
    ...
    [Migration("20210512130955_AddFadeValue")]
    partial class AddFadeValue
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EE579.Domain.Entities.Device", b =>
                {
                    ...
                    b.Property<DateTime>("LastDisconnectionTime")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("EE579.Domain.Entities.Inputs.PotentiometerInput", b =>
                {
                    ...
                    b.Property<int>("LastValue")
                        .HasColumnType("int")
                        .HasColumnName("PotentiometerInput_LastValue");
            ...
            modelBuilder.Entity("EE579.Domain.Entities.Inputs.WebhookInput", b =>
                {
                    b.HasBaseType("EE579.Domain.Entities.RuleInput");
                    ...
                    b.HasDiscriminator().HasValue("WebhookInput");
                });
            ...
            modelBuilder.Entity("EE579.Domain.Entities.Output.BuzzerOffOutput", b =>
                {
                    b.HasBaseType("EE579.Domain.Entities.RuleOutput");

                    b.HasDiscriminator().HasValue("BuzzerOffOutput");
                });
            ...
            modelBuilder.Entity("EE579.Domain.Entities.Output.LedFadeOutput", b =>
                {
                    ...
                    b.Property<bool>("Value")
                        .HasColumnType("bit")
                        .HasColumnName("LedFadeOutput_Value");
            ...
            modelBuilder.Entity("EE579.Domain.Entities.Output.WebhookOutput", b =>
                {
                    b.HasBaseType("EE579.Domain.Entities.RuleOutput");

                    b.Property<bool>("ForwardMessage")
                        .HasColumnType("bit");

                    b.Property<string>("Url")
                        .HasColumnType("nvarchar(max)");

                    b.HasDiscriminator().HasValue("WebhookOutput");
                });
            ...
            modelBuilder.Entity("EE579.Domain.Entities.RuleInput", b =>
                {
                    b.HasOne("EE579.Domain.Entities.DeviceGroup", "DeviceGroup")
                        .WithMany("Inputs")
